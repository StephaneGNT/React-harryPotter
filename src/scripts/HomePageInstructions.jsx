        ...
        return (
            <div id="instructionTable">
                ...
                <div id="gameIndications">
                    ...
                    <span>You start with 3 shields that can protect you from enemy spell ; each of them lasts 3 seconds.</span><br />
                    <span>Try to catch the bonuses</span>
                    <img src={bonus} className="bonus" alt="Bonus image" />
                    <span>and take care of the dementors !</span>
                    <img src={malus} className="bonus" alt="Malus image" /><br />
